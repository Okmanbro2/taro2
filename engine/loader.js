...
var taroRoot = window.BASE_URL ? `${window.BASE_URL}/engine/` : `${window.location.protocol}//${pathArray[2]}/engine/`;
var taroClientRoot = window.BASE_URL ? `${window.BASE_URL}/src/` : `${window.location.protocol}//${pathArray[2]}/src/`;
